  ...
  return (
    <div className="relative max-w-8xl w-full mx-auto flex items-center justify-between px-12 py-4">
      ...
      <ul className="hidden md:flex cursor-pointer items-center justify-evenly gap-[3rem] font-bold text-white py-2 px-2 mt-2 -ml-[10%]">
        <li className="flex items-center gap-1">Products <img src={arrowdown} alt="arrowdown" /></li>
        ...
        <li className="flex items-center gap-1">Company <img src={arrowdown} alt="arrowdown" /></li>
        <li>Learn</li>
      </ul>
      <div className="hidden md:flex items-center justify-evenly gap-4">
        ...
        <img src={maphero} alt="maphero" className="mt-2" />
      </div>
