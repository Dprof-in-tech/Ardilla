...
const Footer = () => {
    return (
        <footer className="bg-[#8807F7] py-10 px-8 relative flex flex-col items-center w-full max-w-8xl">
            <img src={footer} alt='' className='flex absolute -top-[10rem] self-center' />
            <div className="w-[95%] mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 mt-[12rem] border-b border-b-gray-200">
                <div className='flex flex-col items-start w-[400px]'>
                    <h3 className="text-white text-[1rem] font-bold">Products</h3>
                    <ul className='text-gray-200 mt-4 gap-3 flex flex-col items-start mb-12 text-[0.8rem]'>
            ...
            <div className='mt-3 w-[95%]'>
                <div className='flex justify-between items-center'>
                    <p className='text-gray-200 text-[1rem] text-start mt-4'>© 2023 Ardilla. All rights reserved</p>
                    <div className='flex items-center gap-2 mr-12'>
                        <img src={instagram} alt='Instagram logo' className='w-8 h-8 mt-4' />
                        <img src={facebook} alt='Instagram logo' className='w-8 h-8 mt-4' />
                        <img src={linkedin} alt='Instagram logo' className='w-8 h-8 mt-4' />
                        <img src={twitter} alt='Instagram logo' className='w-8 h-8 mt-4' />
                    </div>
                </div>
                <p className='text-gray-200 text-[0.8rem] text-start mt-2'>Ardilla operates under the coorperative license of Ardilla Multipurpose Cooperative Society, LSC 18245, We provide Savings and Fixed deposit services to our users</p>
            </div>
        </footer>
    );
};
