...
const InterestHero = () => {
    return (
        <div className="max-w-8xl w-full mx-auto bg-interestbg bg-cover h-[970px]">
            <Nav />
            <div className=" text-white px-[5rem] py-4 ">
                <h1 className="font-bold text-[2.5rem] text-start mt-4 pl-4 text-white">Calculate Your Interests</h1>
                <div className="flex justify-evenly gap-4 items-start">
                    <form method="post" className="w-[45%]">
                        <div className="w-[65%] flex flex-col items-start mb-8 gap-2">
                        ...
                        <div className="w-[65%] flex flex-col mb-8 gap-2">
                        ...
                        <div className="w-[65%] flex flex-col mb-8 gap-2 mt-4">
                    ...
                    <div className="bg-[#F3F4F6] rounded-t-xl w-[53%] h-[780px] px-16 py-10">
                    <div className="w-[65%] flex flex-col mb-4 mt-4">
                    ...
                    <div className="w-[65%] flex flex-col mb-8 mt-8">
                    ...
                    <div className="w-[65%] flex flex-col mb-8 mt-4">
