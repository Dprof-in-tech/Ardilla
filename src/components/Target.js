        ...
        <div className='max-w-8xl mx-auto h-[fit-content] lg:h-[1300px]'>
            ...
            <div className='flex flex-col items-center justify-center gap-4 px-4 py-4 lg:flex-row lg:justify-evenly lg:gap-4'>
                <div className='w-full lg:w-[32%] h-[fit-content]'>
                    <img loading='lazy' src={phone1} alt='phone1' className='w-full h-auto lg:h-full' />
                </div>
                <div className='w-full lg:w-[32%] h-[fit-content]'>
                    <img loading='lazy' src={phone2} alt='phone2' className='w-full h-auto lg:h-full' />
                </div>
                <div className='w-full lg:w-[32%] h-[fit-content]'>
                    <img loading='lazy' src={phone3} alt='phone3' className='w-full h-auto lg:h-full' />
                </div>
            </div>
            <Faq />
        </div>
